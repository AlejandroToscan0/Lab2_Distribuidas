"""
Cliente CLI para el servidor TCP concurrente de calificaciones.
...
Asegúrate de tener el microservicio NRC en 127.0.0.1:12346 y el servidor concurrente en 127.0.0.1:12345.
"""
...
def menu() -> None:
    ...
    while True:
        ...
        if opcion == "1":
            ...
            cmd = f"AGREGAR|{student_id}|{nombre_canon}|{materia}|{calificacion}"
        elif opcion == "2":
